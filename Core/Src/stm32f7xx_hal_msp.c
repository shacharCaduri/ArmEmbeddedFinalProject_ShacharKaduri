...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C1_MspDeInit 0 */
    ...
    PB9     ------> I2C1_SDA
    */
    HAL_GPIO_DeInit(I2C_1_CLK_Slave_DMA_GPIO_Port, I2C_1_CLK_Slave_DMA_Pin);

    HAL_GPIO_DeInit(I2C_1_SDA_Slave_DMA_GPIO_Port, I2C_1_SDA_Slave_DMA_Pin);
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(I2C_2_CLK_Master_DMA_GPIO_Port, I2C_2_CLK_Master_DMA_Pin);

    HAL_GPIO_DeInit(I2C_2_DATA_Master_DMA_GPIO_Port, I2C_2_DATA_Master_DMA_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC11     ------> UART4_RX
    */
    HAL_GPIO_DeInit(GPIOC, UART4_TX_DMA_Pin|UART4_RX_DMA_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PG14     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOG, USART6_RX_DMA_Pin|USART6_TX_DMA_Pin);
